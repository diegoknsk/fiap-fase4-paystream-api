...
## Descrição
Criar o projeto `FastFood.PayStream.Infra` na pasta `src/Infra/`, que será a camada de infraestrutura contendo implementações de serviços externos (SQS, Mercado Pago, etc.).

## Passos de implementação
- Criar pasta `src/Infra/FastFood.PayStream.Infra/`
...
## Critérios de aceite
- Projeto `FastFood.PayStream.Infra` criado em `src/Infra/FastFood.PayStream.Infra/`
