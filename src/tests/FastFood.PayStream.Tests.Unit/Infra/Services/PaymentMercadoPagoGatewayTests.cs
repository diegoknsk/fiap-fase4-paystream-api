...
public class PaymentMercadoPagoGatewayTests
{
    private readonly PaymentMercadoPagoGateway _gateway;

    public PaymentMercadoPagoGatewayTests()
    {
        _gateway = new PaymentMercadoPagoGateway();
    }

    [Fact]
    public async Task GenerateQrCodeAsync_ShouldReturnMercadoPagoUrl()
    {
        // Arrange
        ...
        result.Should().Contain("api.mercadopago.com");
    ...
    public async Task GenerateQrCodeAsync_WithDifferentParameters_ShouldReturnCorrectUrl()
    {
        ...
        // Assert
        result.Should().Be($"https://api.mercadopago.com/qrcode/{externalReference}?order={orderCode}");
    }

    [Fact]
    public async Task GetReceiptFromGatewayAsync_ShouldReturnSimulatedReceipt()
    {
        // Arrange
        ...
        result.StatusDetail.Should().Be("Pagamento aprovado");
